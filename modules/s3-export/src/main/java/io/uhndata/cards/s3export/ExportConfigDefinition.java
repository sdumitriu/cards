...
public @interface ExportConfigDefinition
{
    ...
    @AttributeDefinition(name = "Export format",
        description = "Whether this should be a JSON, CSV or a TSV. Must be one of 'json', 'csv' or 'tsv'.")
    String export_format() default "json";
    ...
    String secretKey() default "%ENV%S3_SECRET";
}
