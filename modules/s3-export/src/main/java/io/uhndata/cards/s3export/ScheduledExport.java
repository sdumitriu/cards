...
public class ScheduledExport
{
    ...
    public void configAdded(final ExportConfig newConfig)
    {
        ...
        LOGGER.debug("Added s3 export configuration {}", configDef.name());
        final String schedule = StringUtils.defaultIfEmpty(configDef.export_schedule(),
        ...
        final Runnable exportJob = new ExportTask(this.resolverFactory, this.rrp, configDef, "scheduled");
