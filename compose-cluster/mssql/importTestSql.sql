...
INSERT INTO [path].[CL_EP_IP_EMAIL_CONSENT_IN_LAST_7_DAYS]
    (PAT_MRN, PAT_FIRST_NAME, PAT_LAST_NAME, EMAIL_ADDRESS, HOSP_DISCHARGE_DTTM, DISCH_DEPT_NAME, DISCH_LOC_NAME, EMAIL_CONSENT_YN, LoadTime)
    VALUES
    (1234567, 'Alice', 'Smith', 'test@test.com', '2022-09-21T11:16:20.136Z', 'TG-EMERGENCY', 'Toronto General Hospital', 'Yes', CAST(GETDATE()-1 AS DATE));

INSERT INTO [path].[CL_EP_IP_EMAIL_CONSENT_IN_LAST_7_DAYS]
    (PAT_MRN, PAT_FIRST_NAME, PAT_LAST_NAME, EMAIL_ADDRESS, HOSP_DISCHARGE_DTTM, DISCH_DEPT_NAME, DISCH_LOC_NAME, EMAIL_CONSENT_YN, LoadTime)
    VALUES
    (1234568, 'Bob', 'Smith', 'test2@test.com', '2022-09-21T11:16:20.136Z', 'TG-EMERGENCY', 'Toronto General Hospital', 'No', CAST(GETDATE()-1 AS DATE))

INSERT INTO [path].[CL_EP_IP_EMAIL_CONSENT_IN_LAST_7_DAYS]
    (PAT_MRN, PAT_FIRST_NAME, PAT_LAST_NAME, EMAIL_ADDRESS, HOSP_DISCHARGE_DTTM, DISCH_DEPT_NAME, DISCH_LOC_NAME, EMAIL_CONSENT_YN, LoadTime)
    VALUES
    (1234568, 'Bob', 'Smith', 'test2@test.com', '2022-09-21T11:16:20.136Z', 'TW-EMERGENCY', 'Toronto Western Hospital', 'No', CAST(GETDATE()-1 AS DATE))
